  ...
  return (
    <motion.div variants={projectVariant} className="relative">
      <div className={overlayStyles}>
        ...
        <p className="mt-7">
          This website is created by using HTML, CSS, JAVASCRIPT, REACT.JS, TAILWIND.CSS.
          This is responsive website created by me.
        </p>
      </div>
      <img src={`../assets/${projectTitle}.png`} alt={projectTitle} width="400px"/>
    </motion.div>
  );
};
