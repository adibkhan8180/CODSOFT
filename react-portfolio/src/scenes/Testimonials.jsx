    ...
    <section id="testimonials" className="pt-32 pb-16">
      ...
      <div className="md:flex md:justify-between gap-8">
        ...
        >
          ...
          "Talented front-end developer driving exceptional user experiences."
          </p>
        </motion.div>
        ...
        >
          <p className="font-playfair text-6xl">"</p>
          <p className="text-center text-xl">
            "Highly skilled front-end developer creating impressive web
            experiences."
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <p className="font-playfair text-6xl">"</p>
          <p className="text-center text-xl">
            An exceptional front-end developer who consistently delivers
            visually stunning and responsive web experiences.
          </p>
        </motion.div>
      </div>
    </section>
